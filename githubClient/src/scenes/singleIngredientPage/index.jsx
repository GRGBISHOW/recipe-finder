...
const SingleIngredient = () => {
  ...
  const handleUserHistory = async(addedThing) => {
    try{
      const response = await fetch(
        "http://localhost:3001/backend/user/getHistory",
        {
          method: 'PATCH',
          headers: {
  ...
  const getAllLikes = async (UserEmail) => {
    ...
    const response = await fetch("http://localhost:3001/backend/user/allLiked", {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
      },
...
//   const response = await fetch(`http://localhost:3001/backend/recipes/getRecipeByLike/${sanitizedIngredientName}`,{
//       method : "POST",
//       headers: {
//           "Content-Type" : "application/json"
//       },
...
//   const data = await response.json();
  ...
  return (
    <>
      ...
      >
        <img src='http://localhost:3000/assets/Vector 6.png' width='550px' height='280px' />    
            ...
            sx={{
              ...
              backdropFilter:'blur(10px)'
                ...
                sx={{
                  ...
                  <Ingredients 
                  key={ee._id} 
                  ingredientN={JSON.stringify(ee.name)} 
                  size={'265px'}  
                  title={ee.name} />
                </Box>
              </Box>
