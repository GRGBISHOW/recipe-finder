        ...
        return (
            ...
            <Box
              sx={{
                ...
                position:'relative',
                zIndex:'0',
                backgroundImage: `url(http://localhost:3001/backend/assets/${selectedRecipe.imagePath})`,
              ...
              sx={{
                ...
                sx={{
                 ...
                 >
                  <img width='100px'
                     height='100px' 
                     src={`http://localhost:3000/assets/Vector88.svg`} />
                  <Typography
                  textAlign='center'
                  sx={{
                    fontFamily:'quicksand',
                 ...
                 >
                  <img width='100px'
                     height='100px' 
                     src={`http://localhost:3000/assets/Vector66.svg`} />
                     <Typography
                  textAlign='center'
                  sx={{
                    fontFamily:'quicksand',
                ...
                >
                 ...
                 <img width='60px'
                 height='60px' 
                 src={`http://localhost:3000/assets/Heart2.svg`} /> 
                 </Box>):
                 (
                  <img width='60px'
                 height='60px' 
                 src={`http://localhost:3000/assets/Heart.svg`} />
                 )}
                </Box>
              </Box>
            </Box>
