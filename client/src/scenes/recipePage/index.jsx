...
//   const selectedRecipes = useSelector((state) => state.selectedRecipes);
  ...
  //     if(!starTouched){
  //         const response = await fetch("https://onlygunicorn.xyz/backend/recipes/addStar/", {
  //             method: "PATCH",
  //             headers: {
  //                 "Content-Type": "application/json",
  //                 "Cache-Control": "no-store",
  ...
  //         const counterResponse = await fetch("https://onlygunicorn.xyz/backend/recipes/removeStar/", {
  //             method: "PATCH",
  //             headers: {
  //                 "Content-Type": "application/json",
  //             },
...
//     const response = await fetch(`https://onlygunicorn.xyz/backend/recipes/${sanitizedIngredientName}`, {
//       method: "POST",
//       headers:{
//         "Content-Type": "application/json",
//       },
