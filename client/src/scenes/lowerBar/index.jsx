...
const LowerBar = () => {
  ...
  return (
    <>
    <Box display='Flex' backgroundColor='#fff' borderRadius='0 0 30px 30px' justifyContent= 'space-between' zIndex='500' padding="20px 50px" style={{ position: "relative"}} id='LowerBar'>
        ...
        {desktopScreens ? (
          <Box display='Flex'>
            <Box onClick={() => navigate("/home")} sx={{
              ...
              <img width='200px' src='https://onlygunicorn.xyz/assets/Group 26.svg' />
            </Box>              
          </Box>
        ) : (
          <Typography
      ...
      {desktopScreens ? (
        ...
        <div id='searchBar' style={{ position: "relative" ,opacity: 0 }}>
          ...
          <IconButton width='26px' onClick={() => {setToggleSearchBar(!toggleSearchBar);handleOpactiyChange(!toggleSearchBar);}}>
                <Search />
          </IconButton>
          <IconButton onClick={() => navigate(`/camera`)}>
            <img width='26px' src='https://onlygunicorn.xyz/assets/Group 47.svg' />
          </IconButton>
          <IconButton width='26px' onClick={() => navigate(`/home/${user.email}/history`)}>
            <HistoryIcon width='26px'  sx={{ fontSize: "25px" }} />
          </IconButton>
          <Box
            sx={{
              '&:hover':{
          ...
          >
            <img
              src={`https://onlygunicorn.xyz/backend/assets/${imagePath}`}
              width="100%"
              height="100%"
              alt="User"
