        ...
        <Box sx={{
            ...
            <Box display='flex' flexDirection='column' left='5%' position='relative'>
                <Box marginBottom='15px'>
                    <img width='250px' src='https://onlygunicorn.xyz/assets/Group 26.png' />
                </Box>
                <Box>
                    <img width='250px' src='https://onlygunicorn.xyz/assets/2020.png' />
                </Box>
            </Box>
            ...
            onClick={() => { 
                ...
                >
                <img width='70px' src='https://onlygunicorn.xyz/assets/Group 130.png' />
            </Box>
            <Box right='5%' position='relative'>
                <img width='250px' src='https://onlygunicorn.xyz/assets/Group 61.png' />
            </Box>
        </Box>
    )
